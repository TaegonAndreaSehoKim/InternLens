...
- Recommendation cards explain matches more clearly with fit summaries, matched skills, reasons, and check items.
...
- Improve dashboard copy and empty states now that profile setup is less free-form.
